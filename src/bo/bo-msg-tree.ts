...
export class TBaseToken {
    ...
    static UseLongNames: boolean = false;
    static BO: TBO = null;
    ...
    get ActionID(): number { return this.FActionID; }
}
...
export class TStartlist extends TInputValue {
    ...
    constructor(public BO: TBO, public MsgToken: TMsgToken, aOwner: TBaseToken, aNameID: string) {
