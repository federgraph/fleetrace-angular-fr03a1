...
export class TStammdatenRowCollectionItem extends TBaseRowCollectionItem<
    ...
    getItem(index: number): string {
        switch (index) {
            case 1: return this.FFN;
            case 2: return this.FLN;
            case 3: return this.FSN;
            case 4: return this.FNC;
            case 5: return this.FGR;
            case 6: return this.FPB;
            default:
                {
    ...
    setItem(index: number, value: string) {
        switch (index) {
            case 1: this.FFN = value; break;
            case 2: this.FLN = value; break;
            case 3: this.FSN = value; break;
            case 4: this.FNC = value; break;
            case 5: this.FGR = value; break;
            case 6: this.FPB = value; break;
            default:
                {
                    if (index > 0 && index <= this.FieldCount) {
                        const p = new TProp();
