...
> {
  ...
  constructor(Collection: TEventRowCollection, BO: TBO) {
    super(Collection, BO);
  ...
  override UpdateCellProp(cp: TEventColProp, cellProp: TCellProp): void {
    // let NumID: number;
    let r: number;
    cellProp.Color = this.ColumnToColorDef(cp, cellProp.Color);
    const NumID = cp.NumID;
  ...
  override ColumnToColorDef(cp: TEventColProp, aColor: TColor): TColor {
  ...
  private FleetColorBold(r: number, aColor: TColor): TColor {
    ...
    switch (i) {
      case 0:
        return FleetColor.clFleetMedalBold;
      case 1:
        return FleetColor.clFleetYellowBold;
      case 2:
        return FleetColor.clFleetBlueBold;
      case 3:
        return FleetColor.clFleetRedBold;
      case 4:
        return FleetColor.clFleetGreenBold;
      default:
        return aColor;
    }
  }
  ...
  private FleetColor(r: number, aColor: TColor): TColor {
    ...
    switch (i) {
      case 0:
        return FleetColor.clFleetMedal;
      case 1:
        return FleetColor.clFleetYellow;
      case 2:
        return FleetColor.clFleetBlue;
      case 3:
        return FleetColor.clFleetRed;
      case 4:
        return FleetColor.clFleetGreen;
      default:
        return aColor;
    }
  }
  ...
  get GPoints(): string {
    return this.Race[0].Points;
  }
  get GTime1(): number {
    return this.Race[0].CTime1;
  }
  get GRank(): number {
    return this.Race[0].Rank;
  }
  get GPosR(): number {
    return this.Race[0].PosR;
  }
  get PLZ(): number {
    return this.Race[0].PLZ;
  }
}
...
> {
  ...
  public GetSortKeyPoints(cr: TEventRowCollectionItem, value: string, ColName: string): string {
    ...
    if (cr.ru.ShowPoints === TEventNode.LayoutFinish) {
      ...
      // default: if (cr.ru.ShowPoints == TEventNode.Layout_Points)
  ...
  public override InitColsAvail(): void {
  ...
  public override GetTextDefault(cr: TEventRowCollectionItem, value: string): string {
...
export class TEventRowCollection extends TBaseRowCollection<
  ...
  TEventColProp
> {
  constructor(Node: TEventNode, BO: TBO) {
    super(Node, BO);
  }
  ...
  FillFleetList(FL: TEventRowCollectionItem[], r: number, f: number): void {
    FL.length = 0;
...
> {
  ...
  constructor(ColBO: TEventBO, BO: TBO) {
    super(ColBO, BO);
  ...
  FillFleetList(r: number, f: number, L: TEventRowCollectionItem[]): number {
    const result = 0;
    if (r > 0 && r < this.RCount) {
      this.Collection.forEach((cr: TEventRowCollectionItem) => {
        if (cr.Race[r].Fleet === f) {
