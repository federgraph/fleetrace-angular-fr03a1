...
export class TPenaltyISAF {
  ...
  protected GetAsInteger(): number {
    ...
    switch (this.FPenaltyDSQ) {
      case TISAFPenaltyDSQ.DSQ:
        result = result | TPenaltyISAF.ISAF_DSQ;
        break;
      case TISAFPenaltyDSQ.DNE:
        result = result | TPenaltyISAF.ISAF_DNE;
        break;
      case TISAFPenaltyDSQ.RAF:
        result = result | TPenaltyISAF.ISAF_RAF;
        break;
      case TISAFPenaltyDSQ.OCS:
        result = result | TPenaltyISAF.ISAF_OCS;
        break;
      case TISAFPenaltyDSQ.BFD:
        result = result | TPenaltyISAF.ISAF_BFD;
        break;
      case TISAFPenaltyDSQ.DGM:
        result = result | TPenaltyISAF.ISAF_DGM;
        break;
      case TISAFPenaltyDSQ.UFD:
        result = result | TPenaltyISAF.ISAF_UFD;
        break;
    }

    switch (this.FPenaltyNoFinish) {
      case TISAFPenaltyNoFinish.TLE:
        result = result | TPenaltyISAF.ISAF_TLE;
        break;
      case TISAFPenaltyNoFinish.DNF:
        result = result | TPenaltyISAF.ISAF_DNF;
        break;
      case TISAFPenaltyNoFinish.DNS:
        result = result | TPenaltyISAF.ISAF_DNS;
        break;
      case TISAFPenaltyNoFinish.DNC:
        result = result | TPenaltyISAF.ISAF_DNC;
        break;
      case TISAFPenaltyNoFinish.NOF:
        result = result | TPenaltyISAF.ISAF_NOF;
        break;
      case TISAFPenaltyNoFinish.NoFinishBlank:
        break;
    }
    ...
    for (let i = TPenaltyISAF.TISAFPenaltyOtherLow; i <= TPenaltyISAF.TISAFPenaltyOtherHigh; i++) {
      if (this.PenaltyOther.IsMember(i)) {
        ...
        switch (other) {
          case TISAFPenaltyOther.STP:
            result = result | TPenaltyISAF.ISAF_STP;
            break;
          case TISAFPenaltyOther.TIM:
            result = result | TPenaltyISAF.ISAF_TIM;
            break;
          case TISAFPenaltyOther.ZFP:
            result = result | TPenaltyISAF.ISAF_ZFP;
            break;
          case TISAFPenaltyOther.AVG:
            result = result | TPenaltyISAF.ISAF_AVG;
            break;
          case TISAFPenaltyOther.SCP:
            result = result | TPenaltyISAF.ISAF_SCP;
            break;
          case TISAFPenaltyOther.RDG:
            result = result | TPenaltyISAF.ISAF_RDG;
            break;
          case TISAFPenaltyOther.MAN:
            result = result | TPenaltyISAF.ISAF_MAN;
            break;
          case TISAFPenaltyOther.CNF:
            result = result | TPenaltyISAF.ISAF_CNF;
            break;
          case TISAFPenaltyOther.TMP:
            result = result | TPenaltyISAF.ISAF_TMP;
            break;
          case TISAFPenaltyOther.DPI:
            result = result | TPenaltyISAF.ISAF_DPI;
            break;
        }
      }
    }
  ...
  protected SetAsInteger(Value: number): void {
    ...
    switch (i) {
      case TPenaltyISAF.ISAF_DSQ:
        this.FPenaltyDSQ = TISAFPenaltyDSQ.DSQ;
        break;
      case TPenaltyISAF.ISAF_DNE:
        this.FPenaltyDSQ = TISAFPenaltyDSQ.DNE;
        break;
      case TPenaltyISAF.ISAF_RAF:
        this.FPenaltyDSQ = TISAFPenaltyDSQ.RAF;
        break;
      case TPenaltyISAF.ISAF_OCS:
        this.FPenaltyDSQ = TISAFPenaltyDSQ.OCS;
        break;
      case TPenaltyISAF.ISAF_BFD:
        this.FPenaltyDSQ = TISAFPenaltyDSQ.BFD;
        break;
      case TPenaltyISAF.ISAF_DGM:
        this.FPenaltyDSQ = TISAFPenaltyDSQ.DGM;
        break;
      case TPenaltyISAF.ISAF_UFD:
        this.FPenaltyDSQ = TISAFPenaltyDSQ.UFD;
        break;
    }
    ...
    switch (i) {
      case TPenaltyISAF.ISAF_TLE:
        this.FPenaltyNoFinish = TISAFPenaltyNoFinish.TLE;
        break;
      case TPenaltyISAF.ISAF_DNF:
        this.FPenaltyNoFinish = TISAFPenaltyNoFinish.DNF;
        break;
      case TPenaltyISAF.ISAF_DNS:
        this.FPenaltyNoFinish = TISAFPenaltyNoFinish.DNS;
        break;
      case TPenaltyISAF.ISAF_DNC:
        this.FPenaltyNoFinish = TISAFPenaltyNoFinish.DNC;
        break;
      default:
        this.FPenaltyNoFinish = TISAFPenaltyNoFinish.NoFinishBlank;
