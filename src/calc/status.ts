...
export class TStatusStrings {
  getString(status: TStatusEnum): string {
    switch (status) {
      case TStatusEnum.csOK:
        return 'ok';
      case TStatusEnum.csDNS:
        return 'dns';
      case TStatusEnum.csDNF:
        return 'dnf';
      case TStatusEnum.csDSQ:
        return 'dsq';
      case TStatusEnum.csDSQPending:
        return '*';
    }
    return '';
  }
...
export class TStatus implements TPenalty {
  ...
  GetAsInteger(): number {
    switch (this.Status) {
      case TStatusEnum.csOK:
        return StatusConst.StatusOK;
      case TStatusEnum.csDSQ:
        return StatusConst.StatusDSQ;
      case TStatusEnum.csDNF:
        return StatusConst.StatusDNF;
      case TStatusEnum.csDNS:
        return StatusConst.StatusDNS;
      case TStatusEnum.csDSQPending:
        return StatusConst.StatusDSQPending;
      default:
        return StatusConst.StatusOK;
    }
  }
