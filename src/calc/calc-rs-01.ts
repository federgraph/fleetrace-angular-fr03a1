...
export class TCalcEventProxy01 extends TCalcEventProxy {
  ...
  protected IsOK(Value: number): boolean {
    return Value === StatusConst.StatusOK || Value === StatusConst.StatusDSQPending;
  }

  override Calc(qn: TEventNode): void {
    ...
    const RaceCount = qn.Collection.Items[0].RCount;
