...
export const EditbarIcons = [
  [
    IconEnum.check_box_outline_blank,
    'Timing Options',
    IconAction.Toggle,
    IconColor.Primary,
    'toggleChecks()',
  ...
  [
    IconEnum.radio_button_unchecked,
    'Timing Radios',
    IconAction.Toggle,
    IconColor.Primary,
    'toggleRadios()',
...
export const EventIcons = [
  ...
  [
    IconEnum.sort,
    'reset to default sort order (debug)',
    IconAction.Execute,
    IconColor.Primary,
    'sortOrderClear()',
  ],
...
export const EntriesIcons = [
  ...
  [
    IconEnum.control_point,
    'ensure table has number of rows',
    IconAction.Execute,
    IconColor.Normal,
    'ensureCount()',
  ],
  [
    IconEnum.edit,
    'load fixed set of example names (debug)',
    IconAction.Execute,
    IconColor.Normal,
    'loadNames()',
  ],
  [
    IconEnum.delete_forever,
    'clear content, all names in all rows',
    IconAction.Toggle,
    IconColor.Normal,
    'clear()',
  ],
